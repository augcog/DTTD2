...
### Updates:
- 09/10/24 Our MoCap data collection pipeline has been released [here](https://github.com/OpenARK-Berkeley/DTTDv2-IPhoneLiDAR)(iPhone-ARKit-based version), and the release of the data capture app [here](https://github.com/OpenARK-Berkeley/iphone-capture-app). For the previous released Azure-based version [here](https://github.com/augcog/DTTDv1)
